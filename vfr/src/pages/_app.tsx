...
const desktopTutorial = (introJs: typeof import("intro.js").default) => {
    introJs()
      .setOptions({
        steps: [
          {
...
const mobileTutorial = (introJs: typeof import("intro.js").default) => {
    introJs()
      .setOptions({
        steps: [
          {
...
export default function App({ Component, pageProps }: AppProps) {
  ...
  const [tutorialType, setTutorialType] = useState<"desktop" | "mobile" | null>(null);
